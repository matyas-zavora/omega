...
/**
 * Creates the database alpha3 with the tables company, log, owner, ownership_list, parcel, user
...
function createDatabaseA3(mysqli $conn)
{
    ...
    $conn->query("CREATE DATABASE IF NOT EXISTS `alpha3` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;");
