    ...
    echo '<div class="row">';
            ...
            echo '<div class="card">';
                echo '<div class="card-body">';
                    echo '<div class="row mb-2">';
                        echo '<img src="trimify/img/favicon/android-chrome-512x512.png" class="card-img-top img-fluid"';
                        echo 'alt="Project 1" style="height: 5rem; width: auto;">';
                        echo '<div class="col">';
                            echo '<h5 class="card-title">Trimify</h5>';
                            echo '<p class="card-text">File shortener</p>';
                            echo '</div>';
                        echo '</div>';
                    echo '<button type="button" class="btn btn-primary" data-bs-toggle="collapse"';
                    echo 'data-bs-target="#project1Collapse" aria-expanded="false" aria-controls="project1Collapse">';
                    echo 'Details';
                    echo '</button> ';
                ...
                echo '<div class="collapse" id="project1Collapse">';
                    echo '<div class="card card-body">';
                        echo 'Website that allows the user to upload a text file and then shorten it (or make it longer)';
                        echo 'based on user\'s criteria. The processing is done by a backend written in php. The website is';
                        echo 'written in html, css and javascript.';
                        echo '</div>';
                    echo '</div>';
                echo '</div>';
            echo '</div>';
        echo '<div class="col-lg-12 mb-4">';
            echo '<div class="card">';
                echo '<div class="card-body">';
                    echo '<div class="row mb-2">';
                        echo '<img src="estateatlas/img/favicon/android-chrome-512x512.png" class="card-img-top img-fluid"';
                        echo 'alt="Project 1" style="height: 5rem; width: auto;">';
                        echo '<div class="col">';
                        ...
                        echo '</div>';
                    echo '<button type="button" class="btn btn-primary" data-bs-toggle="collapse"';
                    echo 'data-bs-target="#project2Collapse" aria-expanded="false" aria-controls="project2Collapse">';
                    echo 'Details';
                    echo '</button> ';
                ...
                echo '<div class="collapse" id="project2Collapse">';
                    echo '<div class="card card-body">';
                        echo 'A website that allows the user to delete, view and upload data onto a premade database based on';
                        echo 'Cadastre of Real Estate. The processing is done by a backend written in php. The website is';
                        echo 'written';
                        echo 'in html, css and javascript.';
                        echo '</div>';
                    echo '</div>';
                echo '</div>';
            echo '</div>';
        echo '<div class="col-lg-12 mb-4">';
            echo '<div class="card">';
                echo '<div class="card-body">';
                    echo '<div class="row mb-2">';
                        echo '<img src="listease/img/favicon/android-chrome-512x512.png" class="card-img-top img-fluid"';
                        echo 'alt="Project 1" style="height: 5rem; width: auto;">';
                        echo '<div class="col">';
                        ...
                        echo '</div>';
                    echo '<button type="button" class="btn btn-primary" data-bs-toggle="collapse"';
                    echo 'data-bs-target="#project3Collapse" aria-expanded="false" aria-controls="project3Collapse">';
                    echo 'Details';
                    echo '</button> ';
                ...
                echo '<div class="collapse" id="project3Collapse">';
                    echo '<div class="card card-body">';
                        echo 'Shopping list website that allows the user to add, remove and edit items on the list. The';
                        echo 'processing is done by a backend written in php. The website is written in html, css and';
                        echo 'javascript.';
                        echo '</div>';
                    echo '</div>';
                echo '</div>';
