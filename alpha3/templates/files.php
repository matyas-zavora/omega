    ...
    <div class="row">
        <div class="col-md-6">
            <a class="btn btn-warning btn-lg btn-block" href="./download_full_parcel_data.php" role="button"><span
                    class="material-symbols-outlined" style="font-size:250px;">download</span><br>Download full parcel
                data</a>
        </div>
        <div class="col-md-6">
            <a class="btn btn-warning btn-lg btn-block" href="./upload.php" role="button"><span
                    class="material-symbols-outlined" style="font-size:250px;">upload_file</span><br>Upload full parcel
                data</a>
        </div>
    </div>
    <div class="row">
